...
Die Projektstunden stammen nun aus synthetischen, datierten Demo-Zeitdatensätzen mit Bau-Nr. und `acceptedMinutes`. Das Projektblatt gruppiert Gesellen-/Azubistunden und rohe Fahrzeit nach ISO-Kalenderwoche **einschließlich Jahr**. Eine eindeutig einem Datum und Mitarbeiter zuordenbare Bürokorrektur des Wochenzettels ändert diese Zeitprojektion; die frühere bestätigte Wochenzettelversion bleibt eingefroren. Bei mehr als 54 Wochen enthält das Blatt eine bezeichnete Fortsetzung, die in die bestehenden Summenanker einfließt. Das ist noch **keine** produktive Rohereignis- und Freigabepipeline: Aktuelle mobile Zeitaktionen werden nicht automatisch als akzeptierte Projektstunden verbucht, und mehrdeutige historische Korrekturen werden nicht erraten. Auch eine Mitarbeiterbestätigung ist nicht automatisch eine Bürofreigabe.
