...
Bewertete Demo-Basis: öffentliche, rein statische Bedienungsdemo (Demo-Version 11)
...
| Geschäftsführung | Mehr / Verwaltung | Nutzer, Rollen, Support- und Updatebereiche erreichen | [2 – WAHRSCHEINLICH] aus Meeting; durch spätere Projektentscheidung vom 12.09.2026 für die Demo konkretisiert | Demo-Verwaltungsfall | vier Verwaltungskonten, Projekte, Mitarbeiter, Büro-Hilfe und Audit | Verwaltung | Bereich öffnen | Torben und Steffen können Stammdaten verwalten und operative Hilfe leisten | Produktive Rechte müssen serverseitig umgesetzt werden |

### 3.3 Büro

| Rolle | Ansicht | Funktion | fachlicher Status | synthetisches Testszenario | erforderliche Demo-Daten | Navigation | mögliche Nutzeraktion | erwartetes Ergebnis | offene Frage, falls vorhanden |
|---|---|---|---|---|---|---|---|---|---|
| Büro | Büro-Startseite | Offene Prüfaufgaben und Betriebsverwaltung bündeln | [2 – WAHRSCHEINLICH] aus Meeting; gleiche umfangreiche Demorechte durch spätere Projektentscheidung vom 12.09.2026 | S05–S14, S22 sowie Büro-Hilfefall | Zeitprobleme, Korrekturen, Zusatzarbeiten, Wochenzettel, Projekte, Mitarbeiter und Abrechnungshinweise | Heute / Büro / Verwaltung | Arbeitsvorrat oder Verwaltung öffnen | Beide Büro-Demokonten können prüfen, Stammdaten verwalten und Mitarbeitern unmittelbar helfen | Produktive Rechte müssen serverseitig umgesetzt werden |
| Geschäftsführung / Büro | Verwaltung | Neues Projekt anlegen, bearbeiten, deaktivieren und reaktivieren | Spätere Projektentscheidung vom 12.09.2026; kein Meeting-Beschluss | synthetisches Projekt 26-107 | Bau-Nr., Projekt, Kunde, Adresse, Ansprechpartner, Status, Bearbeiter und Audit | Verwaltung → Projekte | Projekt anlegen, bearbeiten oder Status ändern | Projekt erscheint in Planung und Suche; Archivierung erhält Historie und wird bei aktiver Belegung verhindert | Pflichtfelder und endgültige Archivregeln für den Echtbetrieb |
| Geschäftsführung / Büro | Verwaltung | Mitarbeiter anlegen, bearbeiten, deaktivieren und reaktivieren | Spätere Projektentscheidung vom 12.09.2026; kein Meeting-Beschluss | synthetische Mitarbeiterin Nora Prüfling | Name, Funktion, App-Rolle, Tageszuweisung, Aktivstatus und Audit | Verwaltung → Mitarbeiter | Mitarbeiter anlegen, Stammdaten ändern oder Status ändern | Aktive Person ist planbar; Deaktivierung erhält Zeiten, Dokumente und Audit; Reaktivierung erfolgt zunächst ohne Planung | Produktive Lösch- und Aufbewahrungsregeln bleiben offen |
| Geschäftsführung / Büro | Direkte Büro-Hilfe | Aktuelle Zeitaktion stellvertretend für Mitarbeiter auslösen | Spätere Projektentscheidung vom 12.09.2026; Auditprinzip [1] | Mitarbeiter ruft ohne verfügbares Smartphone im Büro an | Mitarbeiter, Bau-Nr., Zeitaktion, Zeitpunkt, handelndes Verwaltungskonto und Pflichtgrund | Verwaltung → Direkte Büro-Hilfe | aktuelle Aktion auswählen und mit Grund speichern | Eigenes Zeitereignis für den Mitarbeiter; ausgelöst von Torben, Steffen oder Bürokonto; im Audit nachvollziehbar | Identitätsprüfung beim Telefonat und produktive Eskalationsregeln |
...
2. Produktive technische Rechte einzelner Bürokräfte. Für die Bedienungsdemo sind vier gleich umfangreiche Verwaltungskonten durch spätere Projektentscheidung vom 12.09.2026 gesetzt; serverseitige Rechteprüfung bleibt Echtbetriebsaufgabe.
...
> Historischer Prüfvermerk: Die Abschnitte 4 und 5 dokumentieren den Stand vor den inzwischen freigegebenen Ausbaustufen. Der aktuell bedienbare Stand ist Demo-Version 11; die mobile Bestätigung ist in `MOBILE_BESTAETIGUNG.md`, die spätere Verwaltungsentscheidung in `ADMIN_VERWALTUNG.md`, die erweiterten Abläufe in `ERWEITERTE_WORKFLOWS_V10.md` und der vollständige Praxistest in `VIDEO_CALL_QA.md` verifiziert.
